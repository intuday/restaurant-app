...
// 🌟 FIX 1: Interface payload ko badalkar 'tableNumber' strictly append kiya hai
interface PaymentButtonProps {
  paymentMethod: 'COD' | 'ONLINE';
  customerInfo: {
    name: string;
    phone: string;
    email: string;
    tableNumber: string; // 👈 Structural dynamic addition
  };
  isValid: boolean;
  onProcessing: (loading: boolean) => void;
  subtotal: number;
        ...
        const response = await fetch('/api/payment/verify', {
          ...
          body: JSON.stringify({
            ...
            orderData: {
              ...
              phone: customerInfo.phone,
              email: customerInfo.email,
              tableNumber: customerInfo.tableNumber, // 🌟 FIX 2: Dynamic field assigned from parent context
              items: cart,
              subtotal: subtotal,
              tax: tax,
              total: totalAmount, 
              ...
              const verifyRes = await fetch('/api/payment/verify', {
                ...
                body: JSON.stringify({
                  ...
                  orderData: {
                    ...
                    phone: customerInfo.phone,
                    email: customerInfo.email,
                    tableNumber: customerInfo.tableNumber, // 🌟 FIX 3: Dynamic binding inside verification hook
                    items: cart,
                    subtotal: subtotal,
                    tax: tax,
                    total: totalAmount,
