          ...
          {filteredOrders.map((order) => (
            ...
            >
              <div className="flex justify-between items-start flex-wrap gap-2">
                <div>
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className={`px-2.5 py-0.5 rounded-full text-xs font-semibold capitalize ${statusBadgeClass(order.status)}`}>
                      {order.status}
                    </span>
                  </div>
                ...
                <div className="flex items-center gap-2">
                  <select
                    ...
                    className="text-xs px-2.5 py-1.5 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 font-medium"
                  >
              ...
              <div className="mt-4 pt-3 border-t border-gray-100 dark:border-gray-800">
                <p className="text-xs font-bold text-gray-400 uppercase tracking-wide mb-1">Items Summary</p>
                <ul className="text-sm space-y-1 text-gray-600 dark:text-gray-300">
                  {order.items.map((item, index) => (
                    <li key={index}>
                      • {item.name} <span className="font-bold text-orange-500">×{item.quantity}</span>
                    </li>
                  ))}
                </ul>
              </div>

              <div className="mt-4 flex justify-between items-center bg-gray-50 dark:bg-gray-800/40 p-3 rounded-xl text-sm">
